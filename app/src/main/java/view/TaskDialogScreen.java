...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        try {
            ...
            try {
                ...
                throw new RuntimeException("Error saving the task", ex);
            }
            ...
            if (update) { 
                ...
                task.setCompleted(this.task.isCompleted());
    ...
    public void setTaskToUpdate(Task task) {
        ...
        jFormattedTextFieldDeadLine.setText(simpleDateFormat.format(task.getDeadline()));
        update = true;
    }
}
